...
// Try to load QuickBooks routes with error handling
try {
  const quickbooksRoutes = require('./quickbooks');
  app.use('/api/quickbooks', quickbooksRoutes);
  console.log('QuickBooks routes loaded successfully');
} catch (error) {
  console.error('Failed to load QuickBooks routes:', error.message);
  // Add fallback routes if QuickBooks module fails
...
app.listen(port, () => {
  ...
  console.log('QuickBooks integration:', fs.existsSync('./quickbooks.js') ? 'Available' : 'Not found');
});